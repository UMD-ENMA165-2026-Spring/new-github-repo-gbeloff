...
## License
I selected a **GPL V3** as my license, as I want others to be able to utilize this repository. 
And if it happens to be interesting or useful to others, I want them to be able to access it, 
on the condition that they _do not restrict access to those who may want to use a version of it._ 
...
I did not select to add gitignore, as in truth I am not certain what it does, or how utilizing this feature would be to my advantage. 
